...
const App = () => {
	return (
		<div className="flex w-screen h-screen justify-center items-center">
			<div className="min-w-[320px] w-[80vw] h-[80vh] md:max-w-[65vw] xl:max-w-[40vw]  bg-[#F6F6F4] justify-center flex rounded-xl p-10">
				{/* content */}
				<div className="flex items-center flex-col w-full h-full lg:p-5 gap-2">
					{/* title */}
